...
export const getActiveLanguages = cache(async function getActiveLanguages(): Promise<LanguageOption[]> {
...
export const getDefaultLocale = cache(async function getDefaultLocale(): Promise<string> {
